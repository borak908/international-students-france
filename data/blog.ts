...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: 'I moved to Lyon as an international student — here\'s what nobody tells you',
    excerpt: 'After two semesters in Lyon, I can tell you the things the official guides leave out — the good surprises and the frustrating ones.',
    date: '2025-05-12',
    readTime: '7 min read',
    metaTitle: 'Moving to Lyon as an International Student — Honest Review',
    metaDescription: 'What it\'s really like to study in Lyon as an international student — housing tips, daily life, hidden costs, and the things nobody warns you about.',
    content: `## The city looks perfect on paper. It mostly is.

I chose [Lyon](/cities/lyon) because every ranking put it in the top three French cities for students. France's second city, gastronomic capital, two hours from the Alps, growing tech scene. The data looked great. What data doesn't tell you is what it actually *feels* like to arrive alone with two suitcases in a city where you don't know a single person.

The short answer: Lyon is genuinely great. But there are a few things I wish someone had told me before I landed.

## Housing will stress you out more than your coursework

Start looking for accommodation **at least three months before** you arrive. I cannot stress this enough. I found my apartment five weeks before moving and I was considered lucky by my classmates. The rental market in Lyon is competitive, and landlords often require a French guarantor — someone with a French bank account who co-signs your lease.

If you don't have a French guarantor (most of us don't), use **Visale** — a free government guarantor scheme for students under 30. Most people don't know it exists. It takes about a week to get your Visale certificate online, and it genuinely opens doors that would otherwise be closed.

My studio near Croix-Rousse cost €820/month. After CAF (the housing benefit — apply the same day you sign your lease), I got €185/month back. Net cost: €635. Manageable.

## The food is the best thing about living here

Lyon is the gastronomic capital of France, and you feel it immediately. The Halles Paul Bocuse market has intimidating prices, but the neighbourhood markets on Saturday mornings — particularly in Croix-Rousse and Guillotière — are affordable and extraordinary. I spent €40–50/week on groceries and ate better than I ever had.

The CROUS student restaurants serve full hot meals for **€3.30** with a student card. There are about ten of them across the city. I ate there three or four times a week and saved a significant amount over the year.
...
**The bureaucracy is exhausting.** Between the ANEF portal (residence permit), CAF (housing benefit), CPAM (health insurance), and your bank, you will spend the first month in queues and on hold. It is infuriating. Everyone goes through it. It does end.

**Winters are grey and cold.** The Alps are beautiful from a distance but Lyon itself sits in a valley and gets cold, foggy winters. The famous canuts neighbourhoods on the slopes of Croix-Rousse can be brutal in January.

**The social life takes time to build.** French university culture is less campus-focused than in the UK or US. You have to be proactive. Join a student association (BDE) early, say yes to things, be the one who suggests meeting for coffee.

**The transport pass for under-26s is €34/month** for unlimited trams, buses and metro. It's genuinely one of the cheapest in France for a city of this size.
...
If you're deciding between [Lyon](/cities/lyon) and other French cities, compare the full picture — housing, universities, and job market — across all 12 cities on our [cities page](/cities). And if you're weighing it against other options, our [city quiz](/city-quiz) might help you figure out where you actually belong.`,
  },
  {
    ...
    title: 'The cheapest French cities for students in 2025: a data-driven breakdown',
    excerpt: 'We crunched the numbers across 12 French cities. Here\'s where your money goes furthest — and what you give up for the lower price tag.',
    date: '2025-05-28',
    readTime: '6 min read',
    metaTitle: 'Cheapest French Cities for Students 2025 — Data Breakdown',
    metaDescription: 'A data-driven comparison of the cheapest French cities for international students in 2025 — real rent prices, transport costs, and total monthly budgets.',
    content: `## The price gap is bigger than most students realise

International students often compare France to their home countries and conclude it's expensive. That conclusion is partly right and mostly wrong. France has **enormous variation** between cities — a student in [Grenoble](/cities/grenoble) spends roughly half what a student in [Nice](/cities/nice) spends per month. If cost is a real constraint, choosing the right city matters more than almost any other decision.
...
The data is clear: for most students, choosing a cheaper city over Paris or Nice frees up €400–800/month — money that could fund travel, savings, or a much higher quality of life.`,
  },
  {
    ...
    title: 'Paris vs Bordeaux for international students: an honest comparison',
    excerpt: 'Two great French cities. Very different experiences, costs, and career outcomes. Here\'s how to decide between them.',
    date: '2025-06-03',
    readTime: '6 min read',
    metaTitle: 'Paris vs Bordeaux for International Students — Honest Comparison',
    metaDescription: 'Paris vs Bordeaux for international students — an honest side-by-side comparison of cost, universities, career prospects, and quality of life.',
    content: `## Two cities. Very different realities.

Both [Paris](/cities/paris) and [Bordeaux](/cities/bordeaux) are on most international students' shortlists. Both have strong universities, great food, and a social scene that will keep you busy. But the similarities end there. The gap in cost, culture, and career outcomes between these two cities is significant — and making the right choice could define the next two or three years of your life.
...
**Verdict: Bordeaux wins on cost by a significant margin.**

## Universities and academic reputation

**Paris** has no serious rival in France for academic prestige. The Sorbonne, Paris Cité, PSL, Sciences Po Paris, HEC, and École Polytechnique are institutions with genuinely global recognition. If you're in law, business, engineering, or the humanities, Paris has the best options in the country.

**Bordeaux** has a strong but more focused offering. The Université de Bordeaux (55,000 students) is well-regarded, particularly in law, sciences, and medicine. KEDGE Business School has a solid international reputation. Sciences Po Bordeaux is excellent for political science and European affairs. It's not Paris, but it's far from second-rate.

**Verdict: Paris wins on raw academic prestige, but Bordeaux is more than adequate for most fields.**

## Career and internship opportunities

**Paris** is where French corporate headquarters are. Finance, consulting, luxury, tech, fashion — all of it is in Paris. The internship scene is exceptional. If you want to work for a major French or international company, being in Paris gives you access that other cities simply cannot match.

**Bordeaux** has a growing economy — aerospace (Dassault, Airbus nearby), wine and agribusiness, and a digital sector that's expanded significantly. Startup activity is increasing. It's not Paris, but for students targeting specific sectors like wine, food tech, or aerospace, Bordeaux can actually be better positioned.

**Verdict: Paris wins for career opportunities, particularly in finance and corporate France.**

## Quality of life

This is where Bordeaux makes its strongest case. The city is ranked one of the most beautiful in France. The social scene is vibrant, the nightlife is excellent, the food and wine culture is unlike anywhere else, and the Atlantic coast is reachable in 45 minutes. The city is compact enough to feel human — you can cycle almost anywhere — while still being large enough to offer everything you need.

Paris is extraordinary, but the density, cost, and sheer size of the city can be overwhelming. Many students report burnout after a year in Paris that they don't experience in smaller cities. There's also the question of safety — Paris has a lower safety rating than Bordeaux.

**Verdict: Bordeaux wins on day-to-day quality of life.**

## Social life and culture

In Paris, you have access to world-class museums (many free for under-26s), concerts, theatre, and a social scene that never sleeps. The downside is that Paris can feel anonymous. Making lasting friendships in a city of 12 million takes deliberate effort.

Bordeaux has a tight and active student community. With 100,000 students in a city of 260,000, the student presence is strongly felt. The city has a warm, sociable energy that's hard to describe but easy to feel.

## So which one?

Choose **Paris** if:
- Academic prestige is your top priority
- You're targeting finance, consulting, or luxury sectors
- You have family support or significant savings to cover the cost

Choose **Bordeaux** if:
- You want a high quality of life without financial stress
- You're in business, law, sciences, or oenology
- You want a city that feels like a real community, not just a capital

Still not sure? Try our [city quiz](/city-quiz) — it factors in budget, career goals, lifestyle preferences, and field of study to give you a personalised recommendation across all 12 French cities we cover.`,
  },
  {
    slug: 'how-to-apply-caf-housing-aid-international-students',
    title: 'How to apply for CAF housing aid as an international student in France',
    excerpt: 'CAF housing benefit can save you €100–300 every month. Most international students don\'t apply because the process looks complicated. It\'s not.',
    date: '2025-06-10',
    readTime: '5 min read',
    metaTitle: 'How to Apply for CAF Housing Aid in France — Student Guide 2025',
    metaDescription: 'Step-by-step guide to applying for CAF housing benefit (APL) as an international student in France. Get €100–300/month back on your rent.',
    content: `## What is CAF and why does it matter?

CAF stands for *Caisse d'Allocations Familiales* — the French family benefits agency. Among the services they provide is **housing benefit** (called APL — *Aide Personnalisée au Logement*), which reduces your effective rent by €100–300/month depending on your city and rent amount.

This is not a means-tested benefit exclusive to French citizens. International students who are legal residents in France are eligible. Yet a large proportion of eligible students never apply — either because they don't know about it, or because the process looks bureaucratic and confusing.

It is bureaucratic. But it is not actually that complicated once you understand the steps.

## Who is eligible?

You are eligible for CAF housing benefit if you meet all of the following:

- You have a valid residence permit (or a VLS-TS visa that has been validated on the ANEF portal)
- You are renting accommodation (a signed lease in your name)
- Your accommodation meets minimum habitability standards
- You are not living in university halls that already have a built-in subsidy (CROUS residence)

Students from **all nationalities** are eligible, including non-EU students. The amount you receive depends on your rent level, your income (student income is often near zero), and your city.

## Step-by-step: how to apply

**Step 1: Validate your visa or get your residence permit**
Before you can apply to CAF, you need to prove you're a legal resident. If you entered France on a VLS-TS student visa, validate it on the **ANEF portal** (administration-etrangers-en-france.interieur.gouv.fr) within three months of arrival. This is your residence authorisation while you wait for a full card.

**Step 2: Sign your lease**
CAF cannot process your application without a signed rental agreement (*bail*). The benefit is attached to a specific address. Apply as soon as you have the signed document — don't wait until you've moved in.

**Step 3: Open a French bank account**
CAF pays directly into a French bank account. You'll need the IBAN. Banks like BNP Paribas, Société Générale, and La Banque Postale are straightforward for students. N26 and Wise are also accepted. Get this done in your first two weeks.

**Step 4: Create your CAF account online**
Go to **caf.fr** and click *Mon Compte CAF* → *Créer mon compte*. You'll need your French national ID number (NIR) from your social security registration. If you haven't registered for social security yet, do that first through the CPAM (ameli.fr).

**Step 5: Complete the APL application**
Once your account is created, go to *Mes aides* and select *Aide au logement*. The online form will ask for:
- Your lease details (rent amount, start date, landlord's information)
- Your income for the previous year (as a new arrival, this will typically be €0)
- Your bank details

The form is in French. Use a translation tool if needed, but the fields are fairly standard.

**Step 6: Wait (and be patient)**
Processing typically takes 4–8 weeks. CAF will send you confirmation by post. Once approved, payments are made monthly, usually the fifth of the month for the previous month's rent.

**Important: CAF is retroactive from the date of application**, not the start of your lease. Apply immediately when you have your lease — every week you delay is money you don't recover.

## How much will you receive?

The amount depends on your rent, your city, and your household situation. As a rough guide in 2025:

- [Lille](/cities/lille): ~€180–240/month
- [Lyon](/cities/lyon): ~€150–220/month
- [Paris](/cities/paris): ~€130–200/month
- [Grenoble](/cities/grenoble): ~€200–280/month
- [Toulouse](/cities/toulouse): ~€190–250/month

Smaller cities with lower rents often qualify for higher percentage reductions.

## Common mistakes to avoid

**Don't wait to apply.** The most common mistake. Apply the same week you sign your lease.

**Don't forget to declare income changes.** If you get a part-time job (students can work up to 964 hours/year in France), declare it on your CAF account within 30 days. Failure to declare can result in repayment demands.

**Don't move without notifying CAF.** If you change address, update your CAF account immediately or your payments stop.

## Final thought

CAF housing benefit is one of the most concrete financial advantages of studying in France rather than the UK or Netherlands. Over a two-year master's programme, €200/month in housing benefit adds up to €4,800 in effective savings. It takes one afternoon to apply. Do it on the day you sign your lease.

For city-specific housing costs and how far your budget will stretch, use our [budget planner](/budget-planner).`,
  },
  {
    slug: 'is-france-worth-it-international-student-verdict',
    title: 'Is France worth it? An international student\'s honest verdict after 2 years',
    excerpt: 'Two years in, here\'s my real answer — not the brochure version, not the horror story. The honest truth about what you gain and what it costs you.',
    date: '2025-06-18',
    readTime: '7 min read',
    metaTitle: 'Is Studying in France Worth It? An Honest Verdict After 2 Years',
    metaDescription: 'An honest, first-person verdict on studying in France as an international student — the bureaucracy, the benefits, the costs, and whether it\'s worth it.',
    content: `## Two years ago I almost didn't come

I was accepted to my programme in [Lyon](/cities/lyon) in March, and spent the next four months finding reasons not to go. The visa process was intimidating. My French was mediocre. I didn't know anyone. The housing market looked brutal. I had a perfectly reasonable offer from a university in the Netherlands where everything would be in English and the bureaucracy would be cleaner.

I came to France anyway. Two years later, here is my honest verdict — not the version I'd put in a promotional brochure, not the cautionary tale I'd use to scare people off. The real one.

## What France gets right that almost nowhere else does

**Tuition fees that don't define your entire adult life.** I paid €2,895/year as a non-EU student. My peers at comparable UK programmes paid £20,000+/year. The difference in financial pressure is not subtle — it's structural. In France, I was able to actually think about my studies, my city, my friendships. I was not constantly doing the maths on return-on-investment.

**A standard of living that rewards you for being here.** With CAF housing benefit, my effective rent was €635/month in Lyon. I ate well. I travelled on weekends. I didn't feel poor. A similar academic experience in London would have required either wealthy parents or crippling loans.

**The country itself.** This sounds obvious, but spending two years in France means you are in France. You take the train to Paris for a weekend. You visit Provence. You go skiing in February. You eat properly, constantly, because it is culturally impossible to do otherwise. This is not a small thing. Quality of life is a real output of studying abroad.

**Work rights that are actually meaningful.** As a student visa holder, I could work up to 964 hours per year — roughly half-time. I worked about 15 hours/week in my second year. It covered my living costs, gave me local work experience, and improved my French faster than any class.

## What France gets wrong

**The bureaucracy is genuinely bad.** I want to be honest about this because it's often downplayed. In my first four months, I dealt with: the ANEF visa validation portal (broke, slow, required multiple attempts), CPAM for health insurance (took three months to process my file), CAF for housing benefit (correct once, then wrong for two consecutive months before being fixed), and a prefecture appointment that was scheduled, cancelled, rescheduled, and ultimately unnecessary because the process had moved online.

None of this was fatal. All of it was solved. But it cost real time and real stress. If you are the kind of person who finds administrative friction disproportionately demoralising, France will test you.

**The language is non-negotiable in daily life.** Even in a city like Lyon with excellent English-taught programmes at EM Lyon and INSA, daily life — landlords, doctors, insurance, the post office — requires French. I came with B1 and reached C1 by the end of two years. That progression was one of the most valuable outcomes of my time here. But if you're expecting an English-language bubble, you won't find one outside specific programme campuses.

**Social integration takes patience.** French social culture is not immediately open. Friendships form more slowly and tend to be more durable once they form. I didn't feel I had a real social network until about six months in. The students I met through my university association became some of my closest friends. But the first semester required genuine effort and some resilience.

## The career question

This is the most pragmatic consideration and the hardest to generalise. France's elite *grandes écoles* system means that if you graduate from HEC, Sciences Po Paris, or Polytechnique, your career ceiling is legitimately high. Public university degrees are respected in France but carry less international brand recognition.

For international students, the most valuable outcome is often not the degree itself but the combination of French language fluency, European professional network, and specific technical skills. The companies hiring from Lyon's engineering schools, from [Toulouse](/cities/toulouse)'s aerospace cluster, from [Grenoble](/cities/grenoble)'s tech ecosystem — they are serious organisations offering serious careers.

If your goal is to work in France or French-speaking markets, two years here is an exceptional investment. If your goal is to return home with a credential that signals quality to employers who have never heard of French universities, the calculation is more complex.

## My actual verdict

France is worth it for the right reasons. It is worth it if you want a high quality of life without being financially crippled. It is worth it if you want language skills that genuinely expand your career geography. It is worth it if you value cultural depth over bureaucratic convenience.

It is not the right choice if you want the cleanest administrative experience, the most internationally recognised brand on your CV, or a place where daily life requires no adaptation.
