...
function renderContent(content: string) {
  ...
  function parseInline(text: string): string {
    return text
      ...
      .replace(/\[([^\]]+)\]\(([^)]+)\)/g, '<a href="$2" class="text-blue-700 underline hover:text-blue-900 font-medium">$1</a>')
  }
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 text-white">
        <div className="h-0.5 bg-gradient-to-r from-[#002395] via-white/40 to-[#ED2939]" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <article className="flex-1 min-w-0 max-w-2xl">
            <p className="text-stone-500 text-base leading-relaxed mb-8 text-lg border-l-4 border-blue-200 pl-4 italic">
              {post.excerpt}
            </p>
            ...
            <div className="mt-10 bg-blue-50 border border-blue-100 rounded-2xl p-6">
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/city-quiz"
                  className="inline-flex items-center gap-2 bg-blue-700 hover:bg-blue-800 text-white text-sm font-semibold px-5 py-2.5 rounded-full transition-colors"
                >
                  Take the city quiz →
                </Link>
                <Link
              ...
              <div className="bg-white rounded-2xl border border-stone-200 p-5">
                ...
                <div className="space-y-4">
                  {related.map((r) => (
                    ...
                    >
                      <p className="text-sm text-stone-700 group-hover:text-blue-700 transition-colors font-medium leading-snug mb-1">
                        {r.title}
                      </p>
                ...
                <Link
                  href="/blog"
                  className="block mt-4 text-xs text-blue-600 hover:text-blue-800 font-medium"
                >
                  All articles →
                </Link>
              </div>
