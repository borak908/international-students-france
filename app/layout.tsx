            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <Link href="/budget-planner" className="block text-xs text-[#90ADDA] hover:text-white transition-colors">Budget Planner</Link>
                  <Link href="/city-quiz"      className="block text-xs text-[#90ADDA] hover:text-white transition-colors">City Quiz</Link>
                  <Link href="/#compare"       className="block text-xs text-[#90ADDA] hover:text-white transition-colors">City Comparison Table</Link>
                </div>
              </div>
              <div>
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                  {cities.map((city) => (
                    <Link key={city.slug} href={`/cities/${city.slug}`} className="text-xs text-[#90ADDA] hover:text-white transition-colors">
                      {city.name}
                    </Link>
                  ))}
                </div>
